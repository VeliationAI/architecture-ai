    ...
    open && mounted ? (
      <div className="fixed inset-0 z-[100] flex justify-end">
        ...
        <div
          ...
          className="relative w-full max-w-md h-full bg-[var(--card)] border-l border-[var(--border)] flex flex-col shadow-[var(--shadow-lg)] animate-slide-up"
        >
            ...
            {history.length === 0 ? (
              <div className="p-8 text-center">
                ...
                <p className="text-xs text-[var(--muted)] mt-1">
                  Generated architectures appear here automatically.
                </p>
              </div>
            ) : (
              history.map((entry) => (
